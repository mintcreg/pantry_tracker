...
| `/get_api_key`              | `GET`      | Securely provide the API key to the frontend.                                                     | **Headers:** `X-API-KEY` required                                                                                                     | **200:** `{"api_key": "the_api_key"}`. <br> **500:** Error message if retrieval fails.                                                                                                                                                                                       |
